...
TAGS = {
    ...
    "landing page": "Shows or discusses a marketing or landing page design.",
    "mobile app": "About mobile apps or mobile interface design.",
    ...
    "ideas": "About generating ideas or creativity.",
